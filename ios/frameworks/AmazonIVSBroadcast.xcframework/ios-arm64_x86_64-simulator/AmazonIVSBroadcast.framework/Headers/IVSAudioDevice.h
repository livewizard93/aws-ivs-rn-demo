...
///
@property (nonatomic, getter=isEchoCancellationEnabled) BOOL echoCancellationEnabled API_AVAILABLE(ios(13.0))__attribute__((deprecated("Echo cancellation must now be controlled throgh IVSStageAudioManager.")));
